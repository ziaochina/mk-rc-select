  ...
  (0, _createClass3['default'])(DropdownMenu, [{
    ...
    value: function render() {
      ...
      if (this.props.dropdownFooter && this.props.dropdownHeader) {
        children = [this.props.dropdownHeader, renderMenu, _react2['default'].createElement(
          'div',
          { onClick: this.handleFooterClick.bind(this) },
          this.props.dropdownFooter
        )];
      } else if (this.props.dropdownFooter) {
        children = [renderMenu, _react2['default'].createElement(
          'div',
          { onClick: this.handleFooterClick.bind(this) },
          this.props.dropdownFooter
        )];
...
DropdownMenu.propTypes = {
  ...
  enableHideDropdownByClick: _propTypes2['default'].bool,
  dropdownFooter: _propTypes2['default'].any,
  dropdownHeader: _propTypes2['default'].any,
